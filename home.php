...
<head>
	...
	<link rel="stylesheet" type="text/css" href="assets/css/web.<?php echo $_CSS_ENGINE; ?>.css" /><?php if ($_CUSTOM_STYLE): ?><link rel="stylesheet" type="text/css" href="assets/css/fixes/<?php echo $_CUSTOM_STYLE; ?>.css" /><?php endif; ?>
