...
O4.ProjectViewController.prototype.createThemes = function(items) {
	...
	for (item in items) {
		...
		style += ".c-" + project + " .project-conclusion { border-color: " + _.adjustSaturation(_.adjustBrightness(color, -10), 50) + "; background-color: " + _.adjustSaturation(_.adjustBrightness(color, 1), 50) + "; color: " + _.adjustSaturation(_.adjustBrightness(color, -50), 100) + "; }";
